        ...
        <div className='bg-white rounded-lg shadow p-6'>
          ...
          <form className='space-y-4' onSubmit={handleSaveProfile}>
            ...
            <div className='flex flex-col items-start gap-3'>
              ...
              <div className='group relative w-24 h-24 mt-2'>
                <img
                  src={
...
<img
                 ...
                 className='w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 to-pink-200 object-cover mt-2'
                />
                 <div className='absolute hidden group-hover/cover:flex bottom-0 right-0 left-0 top-0 bg-black/20 rounded-lg items-center justify-center'>
                  <Pencil className='w-5 h-5 text-white' />
                </div>
...
<div>
<label className='block text-sm font-medium text-gray-700 mb-1'>Bio

</label>
<textarea rows={3} type='text' className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your bio' onChange={(e)=>setEditForm({...editForm,bio:e.target.value})} value={editForm.bio} />
