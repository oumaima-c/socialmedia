...
import { Users, UserPlus, UserCheck, UserPen, MessageSquare } from 'lucide-react'
import {
...
const Connections = () => {
    ...
    const dataArray = [
        ...
        { label: 'Pending', value: pendingConnections, icon: UserPen }, // fixed
